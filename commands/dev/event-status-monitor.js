...
var ncomando = "event-status-monitor";
module.exports = {
    name: `${ncomando}`,
    run: async (client, message, args, dicord) => {
        message.channel.send("Comando en mantenimiento.");
        ...
        message.channel.send("Loading...").then((msg) => {
            setInterval(() => {
                ...
                let estadoalfa = `${netcatalfa.presence.status}`;
                    ...
                    if(estado === "online") {
                        ...
                        if(estadoalfa === "idle") {
                            let estadorealalfa = "<@952298832773931108> : 🟡 EN MANTENIMIENTO 🟡";
                           // msg.edit(estadorealalfa)
                           if(estadobeta === "online") {
                            let estadorealbeta = "<@923322429286285312> : 🟢 ONLINE 🟢";
                            //  msg.edit(estadorealbeta)
                        ...
                        if(estadoalfa === "dnd") {
                            let estadorealalfa = "<@952298832773931108> : 🟠 FUERA DE SERVICIO 🟠";
                            //msg.edit(estadorealalfa)
                            if(estadobeta === "online") {
                                let estadorealbeta = "<@923322429286285312> : 🟢 ONLINE 🟢";
                                //  msg.edit(estadorealbeta)
                        ...
                        if(estadoalfa === "offline") {
                            let estadorealalfa = "<@952298832773931108> : 🔴 BOT CAÍDO O APAGADO 🔴";
                           // msg.edit(estadorealalfa)
                           if(estadobeta === "online") {
                            let estadorealbeta = "<@923322429286285312> : 🟢 ONLINE 🟢";
                            //  msg.edit(estadorealbeta)
            ...
            //ID de NetCat Alfa: 952298832773931108
        })
